...
from sitevisitor.tasks import send_account_status_email
...
def user_status(request, user_id):
    ...
    if user.is_active:
        ...
        send_account_status_email.delay(user.email, 'deactivated')

    else:
        user.is_active = True
        messages.success(request, f'User {user.username} has been activated.')

        send_account_status_email.delay(user.email, 'activated')
